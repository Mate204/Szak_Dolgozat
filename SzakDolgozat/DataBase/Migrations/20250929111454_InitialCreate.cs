    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ContentTag = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    InteractionType = table.Column<int>(type: "int", nullable: false),
                    Score = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecommendationData", x => new { x.UserId, x.ContentTag, x.InteractionType });
                    table.ForeignKey(
                        name: "FK_RecommendationData_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageEmbedding", x => x.ImageId);
                    table.ForeignKey(
                        name: "FK_ImageEmbedding_Images_ImageId",
                        column: x => x.ImageId,
